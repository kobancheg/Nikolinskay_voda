...
<title langs="ru">Счет новый</title>
<style>
<!--
 /* Style Definitions */
...
<p style="font-weight:bold">В платежном поручении указывайте: <input class="b" value="&quot;Оплата заказа № <?=$arOrder["ID"]?> от <?=date("d")?> <?=$months[date("m")]?> <?=date("Y")?> г.&quot;"/></p>
  ...
  <p><font size="2" face="Arial, Tahoma, Verdana, Helvetica, sans-serif" style="font-size:12px"><b>Покупатель:</b> <?
	...
	if($arOrder["PERSON_TYPE_ID"] == 2) {
		...
		echo (strlen($arOrderProps["CITY_COUNTRY"])>0 && $arOrderProps["CITY_COUNTRY"] != "Россия" ? htmlspecialchars($arOrderProps["CITY_COUNTRY"].", ") : "");
  ...
  <table width="100%" class="black-border" cellpadding="4" cellspacing="1" bordercolor="#fff" border="1" style="border-collapse:collapse">	
      ...
      <p><font size="2" face="Arial, Tahoma, Verdana, Helvetica, sans-serif" style="font-size:12px"><b><?echo Number2Word_Rus($sum);?></b></font></p>
			<!--<img style="position:absolute;left:5cm" width="117" height="112" src="/bitrix/admin/reports/images/sign.png" /><p class="sign"><font size="2" face="Arial, Tahoma, Verdana, Helvetica, sans-serif" style="font-size:12px">Руководитель предприятия________________________ (Силко Н.Ю.)</font></p>
			<img style="position:absolute;left:4cm" width="117" height="112" src="/bitrix/admin/reports/images/sign.png" /><p class="sign"><font size="2" face="Arial, Tahoma, Verdana, Helvetica, sans-serif" style="font-size:12px">Главный бухгалтер_______________________________ (Силко Н.Ю.)</font></p>
			<img style="position:relative;left:4.3cm;top:-0.8cm" width="144" height="144" src="/bitrix/admin/reports/images/stamp.png" />-->
			<img src="/bitrix/admin/reports/images/podval2.gif" width="416" height="171" border="0"/>
		</div>
